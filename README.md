Due to the security of the firebase database, I've currently disabled writting capabilities hence new recomendations can't be added. However, the existing ones are visible
